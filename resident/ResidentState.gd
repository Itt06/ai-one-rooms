...
func serialize()->Dictionary: return {"cell":[current_cell.x,current_cell.y],"next_cell":[next_cell.x,next_cell.y],"held_item_id":held_item_id,"posture":posture,"posture_target_id":posture_target_id,"revision":revision,"render_position":[render_position.x,render_position.y]}
