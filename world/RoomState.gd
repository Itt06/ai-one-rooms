...
var objects := {
	"bed":{"id":"bed","display_name":"Bed","position":Vector2(170,440),"interaction_point":Vector2(280,440),"supported_actions":["sleep","sit"]},
	"desk":{"id":"desk","display_name":"Desk","position":Vector2(420,440),"interaction_point":Vector2(390,480),"supported_actions":["sit","use_pc","write_diary"]},
	"chair":{"id":"chair","display_name":"Chair","position":Vector2(450,480),"interaction_point":Vector2(450,500),"supported_actions":["sit","read_book","use_pc"]},
	...
	"sink":{"id":"sink","display_name":"Sink","position":Vector2(650,400),"interaction_point":Vector2(620,430),"supported_actions":["drink_water","clean_room"]},
	...
	"toilet":{"id":"toilet","display_name":"Toilet","position":Vector2(740,400),"interaction_point":Vector2(700,430),"supported_actions":["use_toilet"]},
...
func visible_objects() -> Array:
	var result: Array = []
	for id in objects: result.append({"id":id,"name":objects[id].display_name})
	return result
