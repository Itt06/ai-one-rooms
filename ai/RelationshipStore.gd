...
var contacts:Dictionary={
	"girlfriend_01":{"id":"girlfriend_01","display_name":"恋人","relation_type":"girlfriend","relationship":72,"trust":80,"attraction":75,"intimacy_interest":70,"availability":true,"recent_contact_time":"","last_interaction":"","flags":[]},
	"friend_01":{"id":"friend_01","display_name":"友人","relation_type":"friend","relationship":60,"trust":65,"attraction":30,"intimacy_interest":20,"availability":true,"recent_contact_time":"","last_interaction":"","flags":[]},
	...
	"dating_match_01":{"id":"dating_match_01","display_name":"マッチした相手","relation_type":"dating_match","relationship":20,"trust":25,"attraction":65,"intimacy_interest":50,"availability":true,"recent_contact_time":"","last_interaction":"","flags":[]},
	"casual_partner_01":{"id":"casual_partner_01","display_name":"親しい相手","relation_type":"casual_partner","relationship":32,"trust":45,"attraction":70,"intimacy_interest":72,"availability":true,"recent_contact_time":"","last_interaction":"","flags":[]},
	"sex_worker_01":{"id":"sex_worker_01","display_name":"有料サービス","relation_type":"sex_worker","relationship":0,"trust":50,"attraction":50,"intimacy_interest":100,"availability":true,"recent_contact_time":"","last_interaction":"","flags":[]},
	"family_member_01":{"id":"family_member_01","display_name":"家族","relation_type":"family","relationship":70,"trust":75,"attraction":0,"intimacy_interest":0,"availability":true,"recent_contact_time":"","last_interaction":"","flags":[]}
}
...
func sex_partner_candidates(cash:int)->Array:
	...
	for id in contacts:
		...
		if not bool(c.availability) or str(c.relation_type)=="family":continue
...
func invite(contact_id:String,cash:int,time_text:String)->Dictionary:
	...
	if str(c.relation_type)=="family":return {"ok":false,"outcome":"invalid_partner"}
